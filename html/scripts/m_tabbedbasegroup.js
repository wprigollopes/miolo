dojo.declare("MTabbedBaseGroup", null, {
    ...
    moveRight: function (tabbedBaseGroupId)
    {
        // TODO: Check if the tab is selectable (using tabIsSelectable(tabId))
        var tabArray = eval(tabbedBaseGroupId + 'Tabs');
        var activeTabIndex = mtabbedbasegroup.getCurrentTabIndex(tabbedBaseGroupId);
        var tabLength = tabArray.length;
        var nextTabIndex;
        ...
        mtabbedbasegroup.changeTab(tabArray[nextTabIndex], tabbedBaseGroupId);
    },
    moveLeft: function(tabbedBaseGroupId)
    {
        var tabArray = eval(tabbedBaseGroupId + 'Tabs');
        var activeTabIndex = mtabbedbasegroup.getCurrentTabIndex(tabbedBaseGroupId);
        ...
        mtabbedbasegroup.changeTab(tabArray[previousTabIndex], tabbedBaseGroupId);
    }
});
