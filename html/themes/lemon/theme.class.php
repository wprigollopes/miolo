<?php
    class Theme extends MTheme
    {
        ...
        public function init()
        {
            ...
            $img = new ImageButton('', 'Home', $this->manager->getConf('home.url'), $logo);
        ...
        public function generateDefault()
        {
            ...
            $html .= '<div id="m-loading-message-bg"></div><div id="m-loading-message"><div id="m-loading-message-image"><div id="m-loading-message-text">Loading...</div></div></div>';
