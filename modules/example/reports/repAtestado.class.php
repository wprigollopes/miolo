<?
    class repAtestado extends MPDFReport
    {
        ...
        public function generatePageFooter()
        {
            ...
            $this->pdf->ezSetDy(-15);
            $this->pdf->addTextWrap(300, $this->pdf->y, 200, 10, 'Nome do ResponsÃ¡vel', 'center');
        }
    }
?>
