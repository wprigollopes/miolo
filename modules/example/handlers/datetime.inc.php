<?
	...
	$controls = array(
		...
		new MSeparator(),
		new MText('','Obtendo o nome do m̻s 5:'),
		new MLabel('['.$k->getMonthByNumber('5').']'),
		new MLabel('['.$k->getMonthByNumber('05').']'),
		new MSeparator(),
		new MText('','Obtendo o ̼ltimo dia do m̻s:'),
		...
		new MSeparator(),
		new MText('','Adicionando 1 m̻s a 25/01/2006: '),
		...
		new MSeparator(),
		new MText('','Subtraindo 1 m̻s a 25/01/2006: '),
		new MLabel($k->operation('-','25/01/2006','1%M')),
		new MSeparator(),
