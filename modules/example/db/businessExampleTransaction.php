<?php
class BusinessExampleTransaction extends MBusiness implements ITransaction
{
    ...
    {
        $criteria =  $this->getCriteria();
        $criteria->addCriteria('access.group.group','LIKE', "'$group'");
        return $criteria->retrieveAsQuery($criteria);
    }
