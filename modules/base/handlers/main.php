...
$MIOLO->uses( 'classes/bBaseDeDados.php','base');
$MIOLO->uses( 'classes/bString.php','base');
$MIOLO->uses( 'classes/bCatalogo.php','base');
$MIOLO->uses( 'classes/bColumnInfo.php','base');

if ( !$syncModule )
{
    // Adds required classes.
    $MIOLO->uses( 'classes/bForm.php','base');
    $MIOLO->uses( 'classes/bFormRegistration.php','base');
    $MIOLO->uses( 'classes/bFormSearch.php','base');
    $MIOLO->uses( 'classes/bType.php','base');
    $MIOLO->uses( 'classes/bBarraDeFerramentas.php','base');
    $MIOLO->uses( 'classes/bJavascript.php','base');
    $MIOLO->uses( 'classes/bBooleano.php','base');
    $MIOLO->uses( 'classes/bChoice.php','base');
    ...
    if ( strlen($chave) > 0 )
    {
        $MIOLO->uses('handlers/manipulador.php', 'base');
    }
    else
    {
...
else
{
    ...
    $MIOLO->uses( 'classes/bSyncDatabase.php','base');
    $MIOLO->uses( 'classes/bSyncDatabaseContent.php','base');
    $MIOLO->uses( 'classes/bSyncDatabaseFunction.php','base');
    $MIOLO->uses( 'classes/bSyncDatabaseView.php','base');
