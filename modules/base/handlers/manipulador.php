...
if ( $chave )
{
    ...
    /*$formulario = $this->manager->getModulePath($modulo, 'forms/frm' . ucfirst($chave) . '.php');
...
function obterCaminhoForm($modulo, $nome)
{
    ...
    $frmNome = 'frm' . $nome;
    $caminhoDir = $MIOLO->getModulePath($modulo, 'forms/' . $frmNome . '.php');
...
//    $descricaoChave = ucfirst($chave);
    ...
    $formBusca = $MIOLO->getConf('home.modules') . "/$modulo/forms/frm{$descricaoChave}Busca.php";
