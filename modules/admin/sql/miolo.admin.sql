...
CREATE SEQUENCE miolo.seq_miolo_group
    START WITH 100
    INCREMENT BY 1
    NO MAXVALUE
    MINVALUE 100
...
CREATE SEQUENCE miolo.seq_miolo_log
    START WITH 100
    INCREMENT BY 1
    NO MAXVALUE
    MINVALUE 100
...
CREATE SEQUENCE miolo.seq_miolo_session
    START WITH 100
    INCREMENT BY 1
    NO MAXVALUE
    MINVALUE 100
...
CREATE SEQUENCE miolo.seq_miolo_transaction
    START WITH 100
    INCREMENT BY 1
    NO MAXVALUE
    MINVALUE 100
...
CREATE SEQUENCE miolo.seq_miolo_user
    START WITH 100
    INCREMENT BY 1
    NO MAXVALUE
    MINVALUE 100
...
CREATE TABLE miolo.miolo_sequence ( 
       sequence                      CHAR(30)       NOT NULL,
       value                         INTEGER);

ALTER TABLE miolo.miolo_sequence ADD CONSTRAINT PK_miolo_sequence PRIMARY KEY(sequence);

CREATE TABLE miolo.miolo_user ( 
...
ALTER TABLE miolo.miolo_user ADD CONSTRAINT PK_miolo_user PRIMARY KEY(iduser);

CREATE TABLE miolo.miolo_transaction ( 
       idtransaction                 INTEGER        NOT NULL,
       m_transaction                 CHAR(30));

ALTER TABLE miolo.miolo_transaction ADD CONSTRAINT PK_miolo_transaction PRIMARY KEY(idtransaction);

CREATE TABLE miolo.miolo_group ( 
       idgroup                       INTEGER        NOT NULL,
       m_group                       CHAR(50));

ALTER TABLE miolo.miolo_group ADD CONSTRAINT PK_miolo_group PRIMARY KEY(idgroup);

CREATE TABLE miolo.miolo_access ( 
       idgroup                       INTEGER        NOT NULL,
       idtransaction                 INTEGER        NOT NULL,
       rights                        INTEGER);

ALTER TABLE miolo.miolo_access ADD CONSTRAINT PK_miolo_access PRIMARY KEY(idgroup,idtransaction);
ALTER TABLE miolo.miolo_access ADD CONSTRAINT FK_miolo_access2_miolo FOREIGN KEY(idgroup) REFERENCES miolo_group ON DELETE CASCADE;
ALTER TABLE miolo.miolo_access ADD CONSTRAINT FK_miolo_access1_miolo FOREIGN KEY(idtransaction) REFERENCES miolo_transaction ON DELETE CASCADE;

CREATE TABLE miolo.miolo_session ( 
...
ALTER TABLE miolo.miolo_session ADD CONSTRAINT PK_miolo_session PRIMARY KEY(idsession);
ALTER TABLE miolo.miolo_session ADD CONSTRAINT FK_miolo_session1_miolo FOREIGN KEY(iduser) REFERENCES miolo_user;

CREATE TABLE miolo.miolo_log ( 
...
ALTER TABLE miolo.miolo_log ADD CONSTRAINT PK_miolo_log PRIMARY KEY(idlog);
ALTER TABLE miolo.miolo_log ADD CONSTRAINT FK_miolo_log2_miolo FOREIGN KEY(idtransaction) REFERENCES miolo_transaction;
ALTER TABLE miolo.miolo_log ADD CONSTRAINT FK_miolo_log1_miolo FOREIGN KEY(iduser) REFERENCES miolo_user;

CREATE TABLE miolo.miolo_groupuser ( 
       iduser                        INTEGER        NOT NULL,
       idgroup                       INTEGER        NOT NULL);

ALTER TABLE miolo.miolo_groupuser ADD CONSTRAINT PK_miolo_groupuser PRIMARY KEY(iduser,idgroup);
ALTER TABLE miolo.miolo_groupuser ADD CONSTRAINT FK_miolo_groupuser1_miolo FOREIGN KEY(idgroup) REFERENCES miolo_group ON DELETE CASCADE;
ALTER TABLE miolo.miolo_groupuser ADD CONSTRAINT FK_miolo_groupuser2_miolo FOREIGN KEY(iduser) REFERENCES miolo_user ON DELETE CASCADE;
