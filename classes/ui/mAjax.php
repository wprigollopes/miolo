...
* @version    $id: cpaint2.php 311 2006-09-30 08:21:25Z saloon12yrd $
*/
  ...
  class MAjax extends MService {
   ...
   public function initialize($input_encoding = 'UTF-8') {
        ...
        if (!isset($_REQUEST['api_query']) && !isset($_REQUEST['wsdl'])) {
            ...
            $cpaint_function = isset($_REQUEST['cpaint_function']) ? $_REQUEST['cpaint_function'] : '';
            if ($cpaint_function != '') {
                $this->user_function = $cpaint_function;
...
//      $return_value = str_replace(chr(0x3e), '\u003e', $return_value);
    ...
    * @return   array
    */
    public static function decode_array($data, $encoding) {
      $return_value = array();
    ...
    * @return   string
    */
    public static function find_output_charset($encoding) {
      $return_value = 'UTF-8';
