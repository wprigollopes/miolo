...
class MUI extends MService
{
    ...
    {
        return isset($this->icons[$icon]) ? $this->icons[$icon] : null;
    }
    ...
    {  
        $path = $this->manager->getModulePath( $module, 'types' . $this->php );

        if ( file_exists( $path ) )
        {
            $this->manager->uses( 'types' . $this->php, $module );
        }

        $file = is_null($dir) ? "forms/$name" .$this->php : "forms/$dir/$name" .$this->php;
    ...
    {
        $path = $this->manager->getModulePath( $module, 'types' );

        if ( file_exists( $path ) )
        {
            $this->manager->uses( 'types', $module );
        }

        $file = is_null($dir) ? "forms/$class" .$this->php : "forms/$dir/$class" .$this->php;
...
//$this->manager->trace(print_r($m,true));
    ...
    public function getListing( $module, $name, $data = null, $dir = null )
    {
        ...
        if ( $dir )
        {
            $file = "listings/$dir/$name" .$this->php;
        }
        else
        {
            $file = "listings/$name" .$this->php;
        }
    ...
    {
        $file = is_null($dir) ? "grids/$name" .$this->php : "grids/$dir/$name" .$this->php;
    ...
    {
        $file = is_null($dir) ? "reports/$name" .$this->php : "reports/$dir/$name" .$this->php;
