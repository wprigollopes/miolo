    ...
    public function table( $control )
    {
        ...
        if ($n = count($control->colgroup))
        {
            for($i=0; $i<$n; $i++)
            {
                ...
                if ( isset($control->colgroup[$i]['col']) )
                {
        ...
        if ($n = count($control->head))
        {
            ...
            for($i=0; $i<$n; $i++)
            {
                $control->attr['head'][$i] = isset($control->attr['head'][$i]) ? $control->attr['head'][$i] : null;
                $control->head[$i] = isset($control->head[$i]) ? $control->head[$i] : null;
