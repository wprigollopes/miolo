...
//        $this->id        = ( ( $this->name == NULL ) ? 'm'.$this->_numberId : $this->name );
        ...
        $this->inner      = '';
        $this->event      = array();
        $this->formMode   = self::FORM_MODE_WHOLE_ROW;
    ...
    */
    ...
    function getBox()
    {
        ...
        if ( is_null($this->box) )
        {
            $this->box = new mSpan( 'm_' . MUtil::NVL( $this->name, $this->uniqueId ) );
        }
    ...
    function setBoxClass( $cssClass, $add = true )
    {
    ...
    function setBoxAttributes($attr)
    {
        $this->getBox()->setAttributes($attr);
    }

    function getBoxAttributes()
    {
    ...
    */
    ...
    public function eventHandler()
    {
        ...
        if($eventTokens = explode(';', MIOLO::_REQUEST('event')))
        {
            ...
            {
                $params = isset($eventTokens[1]) ? $eventTokens[1] : null;
                $subject->$e($params);
            }
        }
    }
    ...
    {
        return isset($this->event[$event]) && (count($this->event[$event]) > 0);
    }
