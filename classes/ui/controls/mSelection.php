...
class MSelection extends MListControl
{
     ...
     */
    public function __construct($name='', $value='', $label='', $options = NULL, $showValues=FALSE, $hint='', $size='', $allowNullValue=TRUE)
    {
   ...
   public function generateInner()
   {
        ...
        if ($this->getClass() == '')
        {
            $this->setClass('mSelection form-control');
        }

        if ( $this->readonly )
        {
            $this->setClass('mReadOnly form-control');
