...
class MStaticMenu extends MDiv
{
    ...
    const ICON_AUDITORIA = 'mMenuIcon mMenuIconAuditoria';
    const ICON_SUBSTITUIR = 'mMenuIcon mMenuIconSubstituir';
     ...
     */
    public function addCustomItem($label, $onClick, $iconClass = null)
    {
        if ( !$onClick )
        {
            $onClick = 'function() {}';
