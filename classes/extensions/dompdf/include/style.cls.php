...
class Style {
   ...
   * @return Stylesheet
   */
  public function get_stylesheet() { return $this->_stylesheet; }
   ...
   * @return array
   */
  public function munge_color($color) { return $this->munge_colour($color); }  
 ...
 /**#@+
   ...
   * @return string
   */
  public function get_border_top() { return $this->_get_border("top"); }
  public function get_border_right() { return $this->_get_border("right"); }
  public function get_border_bottom() { return $this->_get_border("bottom"); }
  public function get_border_left() { return $this->_get_border("left"); }
  /**#@-*/
   ...
   * @param string $val
   */
  public function set_border_top($val) { $this->_set_border("top", $val); }
  public function set_border_right($val) { $this->_set_border("right", $val); }
  public function set_border_bottom($val) { $this->_set_border("bottom", $val); }
  public function set_border_left($val) { $this->_set_border("left", $val); }
