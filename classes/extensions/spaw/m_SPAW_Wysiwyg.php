...
include ('/usr/local/miolo2/html/scripts/spaw/m_SPAW_Wysiwyg.php');
...
class M_SPAW_Wysiwyg extends MControl
{
    ...
    public function M_SPAW_Wysiwyg($control_name = 'richeditor', $value = '',     $lang = '',        $mode = '',
                          ...
                          $dropdown_data = '')
    {
        self::__construct($control_name, $value, $lang, $mode, $theme, $width, $height, $css_stylesheet, $dropdown_data);
    }

    public function __construct($control_name = 'richeditor', $value = '',     $lang = '',        $mode = '',
                            $theme = '',                  $width = '100%', $height = '300px', $css_stylesheet = '',
                            $dropdown_data = '')
    {
