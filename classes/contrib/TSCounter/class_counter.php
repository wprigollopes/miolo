...
class TScounter extends SupportFunctions {
  ...
  //-----------------------------------------//
  var $reloadRestriction = 300;


  //-----------------------------------------//
  // Set the start value of the visitors     //
  //-----------------------------------------//
  var $visitorStartValue = 1;
  ...
  */
  function TScounter($url_root, $file_path, $data_path) {
  ...
  */
  function _getNumberOf($category) {
