...
class MUtil
{
     ...
     * @return array 
     */
    private static function dataforFirebugConsole($array)
    {
        $MIOLO = MIOLO::getInstance();
    ...
    {
        $valueString = strtoupper((string)$value);
        
        return in_array($valueString, array('1', 'TRUE', 'T', 'SIM', 'YES', 'S', 'Y'));
    }
     ...
     * This method uses Kwaku Otchere's dBug.php which dumps/displays the contents of a variable in a
