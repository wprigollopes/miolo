...
*    Date: August/2002                           *
*                                                *
*    $Id: setup.cpp,v 1.1 2003/06/09 18:08:10 vgartner Exp $
*                                                *
*************************************************/
...
#define BIS_BASE        "bis"
#define BIS_USER        "dbuser"
#define BIS_PASSWD   "REDACTED"

#define CMN_HOST        "127.0.0.1"
#define CMN_BASE        "bis"
#define CMN_USER        "dbuser"
#define CMN_PASSWD   "REDACTED"
    ...
    if ( createConf )
    {
        ...
        */
        ...
        if ( file.open( IO_WriteOnly ) )
        {
            ...
            stream << "$MIOLOCONF['options']['dump']['peer']     = array('127.0.0.1'); \n";
